...
const Hero = () => {
  return (
    <section className="relative min-h-[100dvh] w-full flex flex-col justify-between overflow-hidden pt-16 sm:pt-24 pb-4 sm:pb-6" style={{ background: '#0a0a0a', isolation: 'isolate' }}>
